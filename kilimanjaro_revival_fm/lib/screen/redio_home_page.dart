...
import 'package:kilimanjaro_revival_fm/model/enhanced_radio_program.dart';
import 'package:kilimanjaro_revival_fm/screen/favorites_page.dart';
import 'package:kilimanjaro_revival_fm/screen/login_screen.dart';
import 'package:kilimanjaro_revival_fm/screen/setting_page.dart';
import 'dart:async';
...
class _RadioHomePageState extends State<RadioHomePage> {
  ...
  final List<EnhancedRadioProgram> todayPrograms = [
    ...
    EnhancedRadioProgram(
      title: "HABARI KWA UFUPI",
      start: const TimeOfDay(hour: 10, minute: 0),
      end: const TimeOfDay(hour: 10, minute: 5),
      description: "Habari za ufupi",
      host: "News Team",
    ...
    EnhancedRadioProgram(
      ...
      end: const TimeOfDay(hour: 12, minute: 55),
      description: "Mijadala na habari za jamii",
      host: "Jamvi Team",
      icon: Icons.forum,
    ),

    EnhancedRadioProgram(
      title: "HABARI KAMILI MCHANA",
      start: const TimeOfDay(hour: 13, minute: 0),
      end: const TimeOfDay(hour: 13, minute: 15),
      description: "Habari kamili za mchana",
      host: "News Team",
      icon: Icons.newspaper,
    ),

    EnhancedRadioProgram(
      title: "GOSPEL REVIVAL HUB",
      start: const TimeOfDay(hour: 13, minute: 15),
      end: const TimeOfDay(hour: 16, minute: 0),
      description: "Nyimbo za injili na mafundisho",
      host: "REVIVAL HUB TEAM",
      icon: Icons.church,
    ),

    EnhancedRadioProgram(
      title: "SUN SET DRIVE TIME",
      start: const TimeOfDay(hour: 16, minute: 0),
      end: const TimeOfDay(hour: 18, minute: 30),
      description: "Burudani ya safari ya jioni",
      host: "Drive Team",
    ...
    EnhancedRadioProgram(
      ...
      end: const TimeOfDay(hour: 20, minute: 55),
      description: "Habari zote za michezo",
      host: "Sports Team",
    ...
    EnhancedRadioProgram(
      ...
      description: "Habari za mwisho wa siku",
      host: "News Team",
      icon: Icons.nightlight,
    ),

    EnhancedRadioProgram(
      title: "TUJIFUNZE BIBLIA",
      start: const TimeOfDay(hour: 21, minute: 45),
      end: const TimeOfDay(hour: 22, minute: 45),
      description: "Mafundisho ya Biblia",
      host: "Bible Study Team",
      icon: Icons.menu_book,
    ),

    EnhancedRadioProgram(
      title: "USIKU WA USHINDI",
      start: const TimeOfDay(hour: 22, minute: 45),
      end: const TimeOfDay(hour: 23, minute: 59),
      description: "Maombi na nyimbo za ushindi",
      host: "",
      icon: Icons.star,
    ),

    EnhancedRadioProgram(
      title: "HABARI ZA USIKU (MARUDIO)",
      start: const TimeOfDay(hour: 0, minute: 0),
      end: const TimeOfDay(hour: 5, minute: 0),
      description: "Habari na muziki wa usiku",
      host: "",
  ...
  Future<void> _loadAdsFromAPI() async {
    ...
    try {
      ...
      final result = await api.fetchActiveAds();
  ...
  void _loadDemoAds() {
    setState(() {
      _allAds = [
        Advertisement(
          id: 1,
          title: '🎵: Tangazo la Redio',
          description:
              'Haya ni matangazo ya demo. Unaweza kuongeza matangazo yako halisi kwenye kwa kuwasiliana nasi.',
          imageDisplay:
        ...
        Advertisement(
          ...
          description:
              'Ingia kwenye Soko kubwa kwa kutangaza nasi na uongeze matangazo yako halisi.',
          imageDisplay:
